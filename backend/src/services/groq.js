...
- Messages like "set sugar price to 50 per kg", "purchase price 45", "GST 5%", "supplier Raj Traders", "barcode 123" should be inventory_bulk with product_updates (do not classify as chat).
